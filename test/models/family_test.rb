...
class FamilyTest < ActiveSupport::TestCase
  test 'family schedule' do
    ...
    expected = { Date.parse('2019-11-10') => [{ name: 'ヒブ', period: '第1期', child: frank }, { name: 'ロタウイルス', period: '1回目', child: frank },
                                              { name: '小児用肺炎球菌', period: '1回目', child: frank }, { name: 'Ｂ型肝炎', period: '1回目', child: frank }],
                 ...
                 Date.parse('2020-09-10') => [{ name: 'おたふくかぜ', period: '1回目', child: frank }, { name: 'ヒブ', period: '第4期', child: frank },
                                              { name: '小児用肺炎球菌', period: '4回目', child: frank },
                 ...
                 Date.parse('2021-11-21') => [{ name: 'ヒブ', period: '第3期', child: dave }, { name: 'ロタウイルス', period: '3回目', child: dave },
                                              { name: '小児用肺炎球菌', period: '3回目', child: dave }, { name: '４種混合', period: '2回目', child: dave }],
