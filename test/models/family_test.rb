...
class FamilyTest < ActiveSupport::TestCase
  test 'family schedule' do
    ...
    expected = {
      Date.parse('2019-11-10') => [{name: 'ヒブ', period: "第1期", child: frank}, {name: 'ロタウイルス', period: "1回目", child: frank}, {name: '小児用肺炎球菌', period: "1回目", child: frank}],
      ...
      Date.parse('2020-09-10') => [{name: 'ヒブ', period: "第4期", child: frank}, {name: '小児用肺炎球菌', period: "4回目", child: frank}, {name: '水痘', period: "1回目", child: frank}],
